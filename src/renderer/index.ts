...
export async function check(
  ...
  try {
    ...
    throwEnhancedErrorIfMarpComponent(e as Error, Component);
    return false;
  }
}
...
function throwEnhancedErrorIfMarpComponent(error: Error, Component: any) {
  if (Component[Symbol.for('astro-component')]) {
    ...
    (error as any).hint =
      `This issue often occurs when your Marp component encounters runtime errors.`;
    throw error;
  }
}
